...
Otherwise:
- Check `.sdd/settings/templates/steering-custom/` for available templates
...
- Light references to `specs/` and `.sdd/steering/` are acceptable; avoid other `.sdd/` directories
